...
namespace DMA_Rust.Rust
{
    public class Offsets
    {
        ...
        public static uint BaseNetworkable_c = 0x3B4E770; //BaseNetworkable_c*
        ...
        public static uint[] GameObjectChain = new uint[] { 0x10, 0x30 };
        public static uint[] ToBuffList = new uint[] { 0xb8, 0x0, 0x10, 0x28 };
